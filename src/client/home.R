      ...
      column(9,
             ...
             fluidRow(
               ...
               column(2, div(tags$a(
                 ...
                 target="_blank", 
                 img(src="bing.jpg", height=180, length=180))),
               ),
               column(1),
               column(2, div(tags$a(
                 href="https://www.google.com/", 
                 target="_blank", 
                 img(src="google.jpg", height=180, length=180))),
               ),
               column(1),
               column(2, div(tags$a(
                 href="https://www.rit.edu/",
                 target="_blank", 
                 img(src="ritp.jpg", height=180, length=180))),
               ),
               column(2),
             ),
             hr(),
             fluidRow(
               ...
               column(2, div(tags$a(
                 ...
                 target="_blank", 
                 img(src="git.jpg", height=180, length=180))),
               ),
               column(1),
               column(2, div(tags$a(
                 href="https://www.linkedin.com/in/michael-nersinger/", 
                 target="_blank", 
                 img(src="lin.jpg", height=180, length=180))),
               ),
               column(1),
               column(2, div(tags$a(
                 href="https://trello.com/", 
                 target="_blank", 
                 img(src="trello.jpg", height=180, length=180))),
               ),
               column(2),
             ),
             hr(),
             fluidRow(
               ...
               column(2, div(tags$a(
                 ...
                 target="_blank", 
                 img(src="stack.jpg", height=180, length=180))),
               ),
               column(1),
               column(2, div(tags$a(
                 href="https://www.firstinspires.org/robotics/frc", 
                 target="_blank", 
                 img(src="first.jpg", height=180, length=180))),
               ),
               column(1),
               column(2, div(tags$a(
                 href="https://www.indeed.com/?from=gnav-homepage", 
                 target="_blank", 
                 img(src="indeed.jpg", height=180, length=180))),
               ),
               column(2),
             )
