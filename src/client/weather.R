...
tagList(div(tags$h1(
  ...
  fluidRow(
    ...
    column(6, align="center", uiOutput("weather_icon"), 
           div(tags$h1(textOutput("weather_desc"), 
                       style="font-size: 80px;")), 
           hr(), div(tags$h1(textOutput("out_temp"), 
                             style="font-size: 120px;")), hr(), 
    ),
    column(3, div(),
    ),
  ),
  ...
  fluidRow(
    column(2),
    column(4, align="center", div(tags$h2("Later Today")), hr(), 
           uiOutput("weather_icon_later"), 
           div(tags$h2(textOutput("weather_desc_later"), 
                       style="font-size: 30px;")), hr(), 
           div(tags$h2(textOutput("out_high_later"), 
                       style="font-size: 20px;")), hr(),
    ),
    column(4, align="center", div(tags$h2("Tomorrow")), hr(), 
           uiOutput("weather_icon_1_day"), 
           div(tags$h2(textOutput("weather_desc_1_day"), 
                       style="font-size: 30px;")), 
           hr(), div(tags$h2(textOutput("out_high_1_day"), 
                             style="font-size: 20px;")), hr(),
    ),
    column(2),
  ),
  ...
  fluidRow(
    ...
    column(2, selectInput("graph_type_1", "", choices = c("Temperature", 
                                                          "Dew Point", 
                                                          "Humidity", 
                                                          "Pressure", 
                                                          "Rain", 
    ...
    column(2, selectInput("graph_type_2", "", choices = c("Temperature", 
                                                          "Dew Point", 
                                                          "Humidity", 
                                                          "Pressure", 
                                                          "Rain", 
    ...
    column(2, selectInput("graph_type_3", "", choices = c("Temperature", 
                                                          "Dew Point", 
                                                          "Humidity", 
                                                          "Pressure", 
                                                          "Rain", 
    ...
    column(2, selectInput("graph_type_4", "", choices = c("Temperature", 
                                                          "Dew Point", 
                                                          "Humidity", 
                                                          "Pressure", 
                                                          "Rain", 
  ...
  hr(),
  fluidRow(
    column(6, div(plotOutput("data_graph_1")),
    ),
    column(6, div(plotOutput("data_graph_2")),
    )
  ),
  hr(),
  fluidRow(
    column(6, div(plotOutput("data_graph_3")),
    ),
    column(6, div(plotOutput("data_graph_4")),
    )
  ),
  hr(),
),
